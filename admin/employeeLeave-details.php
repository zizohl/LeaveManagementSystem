                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Details Congé</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">Accueil</a></li>
                                <li><span>Details Congé</span></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if($stats==1){
                                ?>
                                    <span style="color: green">Approuveé</span>
                                    <?php } if($stats==2)  { ?>
                                    <span style="color: red">Déclinée</span>
                                    <?php } if($stats==0)  { ?>
                                ...
                                <tr>
                                     <td ><b>Conditions de congé: </b></td>
                                     <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                </tr>

                                <tr>
                                    <td ><b>Remarque d'admin: </b></td>
                                    <td colspan="12"><?php
                                    if($result->AdminRemark==""){
                                    echo "Action En attente"; 
                                    }
                                    else{
                            ...
                            <tr>
                            <td colspan="12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Définr action</button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Définr action</h5>
                                ...
                                <div class="modal-body">
                                    ...
                                    <select class="custom-select" name="status" required="">
                                        ...
                                        <option value="1">Approuveé</option>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="update">Appliquer</button>
                                </div>
                                </div>
                            </div>
                            </div>
