                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire de modification de departement</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Forme Abregée</label>
