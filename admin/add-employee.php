<?php
    ...
    if($lastInsertId){
    $msg="L'enregistrement a été ajouté avec succès";
    } else {
    $error="ERROR";
    }
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Ajouter une section pour un employés</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">Employée</a></li>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire afin d’ajouter les dossiers des employées</p>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ID d’employé</label>
                                        ...
                                        <h4>Définir le mot de passe pour la connexion des employés</h4>
