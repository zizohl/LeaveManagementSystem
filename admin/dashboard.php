    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                <h1 style="color: white;">Hifeeds Sarl</h1>
                </div>
            </div>
            <div class="main-menu">
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Tableau de bord de l'admin</span></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Types de congés disponibles</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Employés inscrits</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Départements disponibles</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Demande en attente</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Demande refusée</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Demande approuvée</h4>
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="trd-history-tabs">
                                        <ul class="nav" role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="dashboard.php" role="tab">Liste récente</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <select class="custome-select border-0 pr-3">
                                        ...
                                        <tr>
                                            ...
                                            if($stats==1){
                                             ?>
                                                 <span style="color: green">Approuvé<i class="fa fa-check-square-o"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">Déclinée<i class="fa fa-times"></i></span>
                                                 <?php } if($stats==0)  { ?>
                                            <span style="color: blue">En attente <i class="fa fa-spinner"></i></span>
                                            <?php } ?>
                                            ...
                                            <td><a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-secondary btn-sm">Voir les détails</a></td>
                                            </tr>
                                                <?php $cnt++;} }?>
                                            </tbody>
                                                </table>
