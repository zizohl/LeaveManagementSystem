                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Ajout admin Section</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="manage-admin.php"> Gérer l'admin</a></li>
                                <li><span>Add</span></li>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire d'ajouter un nouvel administrateur système</p>
