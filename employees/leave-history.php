                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Mon historique de congés</h4>  
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Tableau d'historique des congés</h4>
                                    ...
                                    <table id="dataTable" class="table table-hover progress-table text-center">
                                        <thead class="bg-light text-capitalize">
                                            <tr>
                                                ...
                                                <th>De</th>
                                                <th>A</th>
                                                <th width="150">Appliquée</th>
                                                <th width="120">Remarque Admin</th>
                                                <th>Statut</th>
                                            </tr>
                                        </thead>
                                        <tbody>
