<?php
    ...
    header('location:../index.php');
        ...
        if($lastInsertId)
        {
             $msg="Votre demande de congé a été traitée, merci..";
        }   else    {
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="leave.php" aria-expanded="true"><i class="ti-user"></i><span>Demander un congé
                                    </span></a>
                            </li>

                            <li class="#">
                                <a href="leave-history.php" aria-expanded="true"><i class="ti-agenda"></i><span>Afficher mon historique de congés
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Demander un congé</h4>
                            <ul class="breadcrumbs pull-left">
                                
                                <li><span>Form de congé</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">Form congé des employés</h4>
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire ci-dessous.</p>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Date de début</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Date de fin</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Décrivez vos conditions</label>
                                            <textarea class="form-control" name="description" type="text" name="description" length="400" id="example-text-input" rows="5"></textarea>
                                        </div>

                                        <button class="btn btn-primary" name="apply" id="apply" type="submit">envoyer</button>
