                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">Mettre à jour mon profil</h4>
                                        <p class="text-muted font-14 mb-4">Veuillez apporter des modifications sur  votre profil</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">D.D.N</label>
                                            <input class="form-control" type="date" name="dob" id="birthdate" value="<?php echo htmlentities($result->Dob);?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Numéro de contact</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Département préféré</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">MODIFIER</button>
