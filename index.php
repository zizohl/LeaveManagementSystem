                ...
                <form method="POST" name="signin">
                    ...
                    <div class="login-form-body">
                        ...
                        <div class="row mb-4 rmber-area">
                            <div class="col-6">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    ...
                                    <label class="custom-control-label" for="customControlAutosizing">Rappelez-moi</label>
                                </div>
                            </div>
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" type="submit" name="signin">connexion <i class="ti-arrow-right"></i></button>
                        </div>
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">Page Admin</a></p>
                        </div>
                    </div>
                </form>
            </div>
